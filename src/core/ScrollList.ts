...
export abstract class ScrollList extends RenderObject {
  ...
  #mouseEventHandler: MouseEventManager
  ...
  #activeItem: ScrollItem | null
  #activeIndex: number = -1

  #hoveredItem: ScrollItem | null
  #hoveredIndex: number = -1

  #eventMaps = { onClick: (item: ScrollItem) => {} }

  #activeEffects: { inertia: ActiveEffect }

  #removeEventsHandler: () => void = () => {}
  #hasRegistered = false
  #wheelTimeout = -1
  #hasInit = false
  #lastScrollY = 0
  ...
  abstract scrollItems(): ScrollItem[];
  ...
  initScrollItems(centeredItem: ScrollItem): void {
    this.#hasInit = true
    if (this.#hoveredItem) {
