...
import { JudgementManager } from '../Managers/JudgementManager';
import { ScoreManager } from '../Managers/ScoreManager';
import { SkipHeadEffect } from '../Effects/SkipHeadEffect';
import { HpEffect } from '../Effects/HpEffect';
import { ModCoverEffect } from '../Effects/ModCoverEffect';
import { HitEffectManager } from '../Managers/HitEffectManager';
import { SectionLineManager } from '../Managers/SectionLineManager';
import { ProgressPercentManager } from '../Managers/ProgressPercentManager';
import { ComboEffect } from '../Effects/ComboEffect';
import { AccuracyManager } from '../Managers/AccuracyManager';
import { StageBoard } from '../Views/StageBoard';
...
import { MapResolver } from '../Models/MapResolver';
import { DEFAULT_DELAY_TIME } from '../Configs/Config';
import type { RankingResult } from '../Views/RankingBoard';
...
export class StageController extends ActiveEffect {
  ...
  private _modEffect: ModCoverEffect | null = null
  ...
  async init(beatmap: Beatmap, rate: number, mods: Mod[]): Promise<void> {
    ...
    if (coverMod) {
      this._modEffect = new ModCoverEffect(coverMod)
